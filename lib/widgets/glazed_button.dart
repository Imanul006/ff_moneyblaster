...
class GlazedButton extends StatefulWidget {
  ...
  const GlazedButton({Key? key, required this.onTap, required this.child}) : super(key: key);

  @override
  _GlazedButtonState createState() => _GlazedButtonState();
}

class _GlazedButtonState extends State<GlazedButton> with SingleTickerProviderStateMixin {
          ...
          child: Stack(
            children: [
              Container(
                ...
                padding: const EdgeInsets.all(18.0), // Add padding here
              ...
              AnimatedPositioned(
                ...
                child: Transform(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: _isAnimating ? Colors.white.withOpacity(0.5) : Colors.transparent,
