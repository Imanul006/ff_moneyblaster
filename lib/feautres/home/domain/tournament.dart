...
class GameType with _$GameType {
    ...
    factory GameType.fromJson(Map<String, dynamic> json) => _$GameTypeFromJson(json);
}
...
class Tournament with _$Tournament {
    factory Tournament({
        ...
        @JsonKey(name: 'dateTime', fromJson: _dateTimeFromTimestamp, toJson: _dateTimeToTimestamp) DateTime? dateTime,
