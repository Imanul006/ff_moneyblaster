...
part 'user_model.g.dart'; // This file will be generated by json_serializable

@freezed
class UserModel with _$UserModel {
  @JsonSerializable(explicitToJson: true) // Add this to enable nested class serialization
